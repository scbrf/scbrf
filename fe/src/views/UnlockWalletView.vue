<template>
    <div class="p-4 w-screen h-screen drag flex flex-col">
        ...
        <label class="input-group input-group-sm w-100 flex justify-center mt-2">
        ...
        <div class="flex justify-center m-2">
            <button class="btn btn-sm btn-outline" :disabled="!validate" @click="createWallet">解锁钱包</button>
        </div>
    </div>
</template>
<script>

...
test('create planet draft', async () => {
  ...
  expect(draft.attachments[0].url).toBe('file:///tmp/p1/Drafts/d1/Attachments/a.png')
  ...
  cpcb()
  expect(draft.audioFilename).toBe('/tmp/p1/Drafts/d1/Attachments/b.mp3')
  draft.attachAudio('/tmp/c.mp3')
  expect(draft.audioFilename).toBe('/tmp/c.mp3')
  cpcb()
  expect(draft.audioFilename).toBe('/tmp/p1/Drafts/d1/Attachments/c.mp3')
  ...
  cpcb()
  expect(draft.videoFilename).toBe('/tmp/p1/Drafts/d1/Attachments/b.mp4')
  draft.attachVideo('/tmp/c.mp4')
  expect(draft.videoFilename).toBe('/tmp/c.mp4')
  cpcb()
  expect(draft.videoFilename).toBe('/tmp/p1/Drafts/d1/Attachments/c.mp4')
})
...
test('draft from article', async () => {
  ...
  expect(draft.audioFilename).toBe('/tmp/p1/Public/a1/a.mp3')
  expect(draft.videoFilename).toBe('/tmp/p1/Public/a1/b.mp4')
